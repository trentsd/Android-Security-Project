...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/discord/stores/StoreEmoji;->buildUsableEmojiSet(Ljava/util/Map;JZZ)Lcom/discord/models/domain/emoji/EmojiSet;
.end annotation
...
# instance fields
.field final synthetic $canUseExternalEmojis:Z
...
# direct methods
.method constructor <init>(JZZLjava/util/HashMap;Ljava/util/HashMap;Ljava/util/Map;)V
    .locals 0

    iput-wide p1, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$targetGuildId:J

    iput-boolean p3, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$canUseExternalEmojis:Z

    iput-boolean p4, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$isMePremium:Z

    iput-object p5, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$emojiNameCounts:Ljava/util/HashMap;

    iput-object p6, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$emojiIdsMap:Ljava/util/HashMap;

    iput-object p7, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$usableCustomEmojis:Ljava/util/Map;
...
.method public final invoke(Ljava/util/Map;J)V
    ...
    iget-boolean v3, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$canUseExternalEmojis:Z
    ...
    iget-boolean v3, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$isMePremium:Z
    ...
    .line 124
    iget-object v2, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$emojiNameCounts:Ljava/util/HashMap;
    ...
    .line 126
    new-instance v3, Lcom/discord/models/domain/emoji/ModelEmojiCustom;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v2

    invoke-direct {v3, v1, v2}, Lcom/discord/models/domain/emoji/ModelEmojiCustom;-><init>(Lcom/discord/models/domain/emoji/ModelEmojiCustom;I)V
    ...
    iget-object v4, p0, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$3;->$emojiNameCounts:Ljava/util/HashMap;
    ...
    invoke-virtual {v2, v4, v5}, Lcom/discord/stores/StoreEmoji$buildUsableEmojiSet$2;->invoke(Ljava/util/Map;Ljava/lang/Object;)V
    ...
    const-string v4, "emoji.uniqueId"
