...
# instance fields
.field private XW:Lcom/franmontiel/persistentcookiejar/cache/CookieCache;

.field private XX:Lcom/franmontiel/persistentcookiejar/persistence/CookiePersistor;
...
.method public constructor <init>(Lcom/franmontiel/persistentcookiejar/cache/CookieCache;Lcom/franmontiel/persistentcookiejar/persistence/CookiePersistor;)V
    ...
    .line 35
    iput-object p1, p0, Lcom/franmontiel/persistentcookiejar/PersistentCookieJar;->XW:Lcom/franmontiel/persistentcookiejar/cache/CookieCache;
    ...
    .line 38
    iget-object p1, p0, Lcom/franmontiel/persistentcookiejar/PersistentCookieJar;->XW:Lcom/franmontiel/persistentcookiejar/cache/CookieCache;

    invoke-interface {p2}, Lcom/franmontiel/persistentcookiejar/persistence/CookiePersistor;->jX()Ljava/util/List;
...
.method public final declared-synchronized a(Lokhttp3/s;)Ljava/util/List;
    ...
    .line 63
    iget-object v2, p0, Lcom/franmontiel/persistentcookiejar/PersistentCookieJar;->XW:Lcom/franmontiel/persistentcookiejar/cache/CookieCache;
    ...
    .line 2121
    iget-wide v4, v3, Lokhttp3/l;->bmx:J
    ...
    .line 2173
    :cond_2
    iget-boolean v4, v3, Lokhttp3/l;->bmC:Z

    if-eqz v4, :cond_3

    .line 2486
    iget-object v4, p1, Lokhttp3/s;->bna:Ljava/lang/String;

    .line 2174
    iget-object v5, v3, Lokhttp3/l;->bmy:Ljava/lang/String;
    ...
    .line 2180
    :cond_5
    iget-boolean v4, v3, Lokhttp3/l;->bmz:Z

    if-eqz v4, :cond_6

    invoke-virtual {p1}, Lokhttp3/s;->Ag()Z
...
.method public final declared-synchronized n(Ljava/util/List;)V
    ...
    .line 43
    :try_start_0
    iget-object v0, p0, Lcom/franmontiel/persistentcookiejar/PersistentCookieJar;->XW:Lcom/franmontiel/persistentcookiejar/cache/CookieCache;
    ...
    .line 1108
    iget-boolean v3, v2, Lokhttp3/l;->bmB:Z
