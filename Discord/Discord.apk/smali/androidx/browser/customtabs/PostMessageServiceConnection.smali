...
.field private mService:Landroid/support/a/c;

.field private final mSessionBinder:Landroid/support/a/a;
...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Landroid/support/a/a;
...
.method public final notifyMessageChannelReady(Landroid/os/Bundle;)Z
    ...
    .line 87
    iget-object v0, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Landroid/support/a/c;
    ...
    .line 90
    :try_start_0
    iget-object v2, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Landroid/support/a/c;

    iget-object v3, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Landroid/support/a/a;

    invoke-interface {v2, v3, p1}, Landroid/support/a/c;->onMessageChannelReady(Landroid/support/a/a;Landroid/os/Bundle;)V
    :try_end_0
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 66
    invoke-static {p2}, Landroid/support/a/c$a;->asInterface(Landroid/os/IBinder;)Landroid/support/a/c;

    move-result-object p1

    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Landroid/support/a/c;
...
.method public final postMessage(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v2, v3, p1, p2}, Landroid/support/a/c;->onPostMessage(Landroid/support/a/a;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
