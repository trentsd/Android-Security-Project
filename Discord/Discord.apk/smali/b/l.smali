...
# instance fields
.field private final bAA:Lokhttp3/w$a;

.field private final bAB:Z

.field bAC:Lokhttp3/MultipartBody$a;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field

.field private bAD:Lokhttp3/q$a;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.field private bAz:Lokhttp3/s$a;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field

.field bnB:Lokhttp3/RequestBody;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field

.field private bnx:Lokhttp3/MediaType;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method constructor <init>(Ljava/lang/String;Lokhttp3/s;Ljava/lang/String;Lokhttp3/Headers;Lokhttp3/MediaType;ZZZ)V
    ...
    .line 53
    iput-object p2, p0, Lb/l;->bAx:Lokhttp3/s;

    .line 54
    iput-object p3, p0, Lb/l;->bAy:Ljava/lang/String;
    ...
    iput-object p1, p0, Lb/l;->bAA:Lokhttp3/w$a;

    .line 56
    iput-object p5, p0, Lb/l;->bnx:Lokhttp3/MediaType;

    .line 57
    iput-boolean p6, p0, Lb/l;->bAB:Z

    if-eqz p4, :cond_0

    .line 60
    iget-object p1, p0, Lb/l;->bAA:Lokhttp3/w$a;
    ...
    iput-object p1, p0, Lb/l;->bAD:Lokhttp3/q$a;
    ...
    iput-object p1, p0, Lb/l;->bAC:Lokhttp3/MultipartBody$a;

    .line 69
    iget-object p1, p0, Lb/l;->bAC:Lokhttp3/MultipartBody$a;
    ...
    .line 1303
    iput-object p2, p1, Lokhttp3/MultipartBody$a;->bnz:Lokhttp3/MediaType;
...
.method static j(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 2133
    :goto_4
    invoke-virtual {v1}, Lokio/c;->BV()Z
    ...
    .line 108
    :cond_7
    invoke-virtual {v3}, Lokio/c;->Cb()Ljava/lang/String;
...
# virtual methods
.method final AE()Lokhttp3/w;
    .locals 5

    .line 191
    iget-object v0, p0, Lb/l;->bAz:Lokhttp3/s$a;
    ...
    .line 197
    :cond_0
    iget-object v0, p0, Lb/l;->bAx:Lokhttp3/s;

    iget-object v1, p0, Lb/l;->bAy:Ljava/lang/String;
    ...
    .line 204
    :goto_0
    iget-object v1, p0, Lb/l;->bnB:Lokhttp3/RequestBody;

    if-nez v1, :cond_4

    .line 207
    iget-object v2, p0, Lb/l;->bAD:Lokhttp3/q$a;
    ...
    iget-object v2, v2, Lokhttp3/q$a;->bmQ:Ljava/util/List;
    ...
    .line 209
    :cond_1
    iget-object v2, p0, Lb/l;->bAC:Lokhttp3/MultipartBody$a;

    if-eqz v2, :cond_3

    .line 3336
    iget-object v1, v2, Lokhttp3/MultipartBody$a;->bny:Ljava/util/List;
    ...
    iget-object v3, v2, Lokhttp3/MultipartBody$a;->bnv:Lokio/ByteString;

    iget-object v4, v2, Lokhttp3/MultipartBody$a;->bnz:Lokhttp3/MediaType;

    iget-object v2, v2, Lokhttp3/MultipartBody$a;->bny:Ljava/util/List;
    ...
    .line 222
    :cond_5
    iget-object v3, p0, Lb/l;->bAA:Lokhttp3/w$a;
    ...
    :cond_6
    :goto_2
    iget-object v2, p0, Lb/l;->bAA:Lokhttp3/w$a;
    ...
    iget-object v2, p0, Lb/l;->bAx:Lokhttp3/s;
    ...
    iget-object v2, p0, Lb/l;->bAy:Ljava/lang/String;
...
.method final addHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 85
    :cond_1
    iget-object v0, p0, Lb/l;->bAA:Lokhttp3/w$a;
...
.method final c(Lokhttp3/Headers;Lokhttp3/RequestBody;)V
    ...
    .line 177
    iget-object v0, p0, Lb/l;->bAC:Lokhttp3/MultipartBody$a;
...
.method final d(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 147
    iget-object v0, p0, Lb/l;->bAy:Ljava/lang/String;

    if-eqz v0, :cond_1

    .line 149
    iget-object v1, p0, Lb/l;->bAx:Lokhttp3/s;

    invoke-virtual {v1, v0}, Lokhttp3/s;->dF(Ljava/lang/String;)Lokhttp3/s$a;

    move-result-object v0

    iput-object v0, p0, Lb/l;->bAz:Lokhttp3/s$a;
    ...
    .line 154
    iput-object v0, p0, Lb/l;->bAy:Ljava/lang/String;
    ...
    iget-object p3, p0, Lb/l;->bAx:Lokhttp3/s;
    ...
    iget-object p3, p0, Lb/l;->bAy:Ljava/lang/String;
    ...
    .line 159
    iget-object p3, p0, Lb/l;->bAz:Lokhttp3/s$a;
...
.method final e(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 169
    iget-object p3, p0, Lb/l;->bAD:Lokhttp3/q$a;
