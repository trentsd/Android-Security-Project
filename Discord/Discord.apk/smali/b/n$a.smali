...
# instance fields
.field private bAI:Lokhttp3/e$a;
...
.field private final bAK:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lb/c$a;",
...
.field private final bAM:Lb/k;

.field private bAx:Lokhttp3/s;

.field private bzZ:Ljava/util/concurrent/Executor;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method private constructor <init>(Lb/k;)V
    ...
    iput-object v0, p0, Lb/n$a;->bAJ:Ljava/util/List;
    ...
    iput-object v0, p0, Lb/n$a;->bAK:Ljava/util/List;

    .line 404
    iput-object p1, p0, Lb/n$a;->bAM:Lb/k;

    .line 407
    iget-object p1, p0, Lb/n$a;->bAJ:Ljava/util/List;
...
# virtual methods
.method public final Dj()Lb/n;
    .locals 8

    .line 562
    iget-object v0, p0, Lb/n$a;->bAx:Lokhttp3/s;

    if-eqz v0, :cond_2

    .line 566
    iget-object v0, p0, Lb/n$a;->bAI:Lokhttp3/e$a;
    ...
    .line 571
    :goto_0
    iget-object v0, p0, Lb/n$a;->bzZ:Ljava/util/concurrent/Executor;

    if-nez v0, :cond_1

    .line 573
    iget-object v0, p0, Lb/n$a;->bAM:Lb/k;

    invoke-virtual {v0}, Lb/k;->Dh()Ljava/util/concurrent/Executor;
    ...
    iget-object v0, p0, Lb/n$a;->bAK:Ljava/util/List;
    ...
    iget-object v0, p0, Lb/n$a;->bAJ:Ljava/util/List;
    ...
    iget-object v3, p0, Lb/n$a;->bAx:Lokhttp3/s;

    iget-boolean v7, p0, Lb/n$a;->bAL:Z
...
.method public final a(Lokhttp3/t;)Lb/n$a;
    ...
    iput-object p1, p0, Lb/n$a;->bAI:Lokhttp3/e$a;
...
.method public final eA(Ljava/lang/String;)Lb/n$a;
    ...
    .line 1594
    iget-object p1, v0, Lokhttp3/s;->bnb:Ljava/util/List;
    ...
    .line 1515
    iput-object v0, p0, Lb/n$a;->bAx:Lokhttp3/s;
