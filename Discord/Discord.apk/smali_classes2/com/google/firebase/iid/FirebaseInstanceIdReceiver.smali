...
# static fields
.field private static aOv:Z = false

.field private static aOw:Lcom/google/firebase/iid/ai;
    .annotation build Ljavax/annotation/concurrent/GuardedBy;
        value = "FirebaseInstanceIdReceiver.class"
    .end annotation
.end field

.field private static aOx:Lcom/google/firebase/iid/ai;
    .annotation build Ljavax/annotation/concurrent/GuardedBy;
        value = "FirebaseInstanceIdReceiver.class"
    .end annotation
.end field
...
.method private static a(Landroid/content/BroadcastReceiver;Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    .locals 5
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/google/firebase/iid/x;->b(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
...
.method private static b(Landroid/content/BroadcastReceiver;Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    .line 48
    :cond_2
    invoke-static {p1, p2}, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->o(Landroid/content/Context;Ljava/lang/String;)Lcom/google/firebase/iid/ai;
    ...
    invoke-virtual {p1, p3, p0}, Lcom/google/firebase/iid/ai;->a(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V

    return v1
.end method

.method private static declared-synchronized o(Landroid/content/Context;Ljava/lang/String;)Lcom/google/firebase/iid/ai;
    .locals 2
    ...
    .line 51
    sget-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->aOx:Lcom/google/firebase/iid/ai;
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/firebase/iid/ai;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->aOx:Lcom/google/firebase/iid/ai;

    .line 53
    :cond_0
    sget-object p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->aOx:Lcom/google/firebase/iid/ai;
    :try_end_0
    ...
    :cond_1
    :try_start_1
    sget-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->aOw:Lcom/google/firebase/iid/ai;
    ...
    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->aOw:Lcom/google/firebase/iid/ai;

    .line 56
    :cond_2
    sget-object p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->aOw:Lcom/google/firebase/iid/ai;
    :try_end_1
