...
.field private bmE:Ljava/lang/Runnable;
...
.field private final bmG:Ljava/util/Deque;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Deque<",
            "Lokhttp3/v$a;",
...
.field private final bmH:Ljava/util/Deque;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Deque<",
            "Lokhttp3/v;",
...
.method public constructor <init>()V
    ...
    .line 40
    iput v0, p0, Lokhttp3/n;->bmC:I

    const/4 v0, 0x5

    .line 41
    iput v0, p0, Lokhttp3/n;->bmD:I
    ...
    iput-object v0, p0, Lokhttp3/n;->bmF:Ljava/util/Deque;
    ...
    iput-object v0, p0, Lokhttp3/n;->bmG:Ljava/util/Deque;
...
.method private declared-synchronized Ac()I
    ...
    .line 255
    :try_start_0
    iget-object v0, p0, Lokhttp3/n;->bmG:Ljava/util/Deque;
...
.method private a(Lokhttp3/v$a;)I
    ...
    .line 7171
    iget-object v3, v2, Lokhttp3/v$a;->bof:Lokhttp3/v;

    .line 196
    iget-boolean v3, v3, Lokhttp3/v;->bod:Z
...
.method private a(Ljava/util/Deque;Ljava/lang/Object;)V
    ...
    .line 221
    iget-object p1, p0, Lokhttp3/n;->bmE:Ljava/lang/Runnable;
...
.method final Ab()Z
    ...
    .line 171
    :try_start_0
    iget-object v1, p0, Lokhttp3/n;->bmF:Ljava/util/Deque;
    ...
    .line 174
    iget-object v3, p0, Lokhttp3/n;->bmG:Ljava/util/Deque;

    invoke-interface {v3}, Ljava/util/Deque;->size()I

    move-result v3

    iget v4, p0, Lokhttp3/n;->bmC:I
    ...
    .line 4187
    iget-object v5, v4, Lokhttp3/v$a;->bof:Lokhttp3/v;

    invoke-static {v5}, Lokhttp3/v;->c(Lokhttp3/v;)Lokhttp3/p;

    .line 4188
    iget-object v5, v4, Lokhttp3/v$a;->bog:Lokhttp3/f;
    ...
    iget-object v5, v5, Lokhttp3/v;->bnY:Lokhttp3/t;

    .line 5390
    iget-object v5, v5, Lokhttp3/t;->bnC:Lokhttp3/n;
    ...
    :goto_4
    iget-object v1, v4, Lokhttp3/v$a;->bof:Lokhttp3/v;
...
.method public final declared-synchronized cancelAll()V
    ...
    .line 145
    :try_start_0
    iget-object v0, p0, Lokhttp3/n;->bmF:Ljava/util/Deque;
    ...
    .line 1171
    iget-object v1, v1, Lokhttp3/v$a;->bof:Lokhttp3/v;

    .line 2130
    iget-object v1, v1, Lokhttp3/v;->bnZ:Lokhttp3/internal/c/j;
