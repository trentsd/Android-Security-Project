...
.field public static final aGo:Lcom/google/android/gms/nearby/messages/MessageFilter;


# instance fields
.field private final aGp:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.method static constructor <clinit>()V
    ...
    .line 3000
    iput-boolean v1, v0, Lcom/google/android/gms/nearby/messages/MessageFilter$a;->aGr:Z

    .line 4000
    iget-boolean v2, v0, Lcom/google/android/gms/nearby/messages/MessageFilter$a;->aGr:Z

    if-nez v2, :cond_1

    iget-object v2, v0, Lcom/google/android/gms/nearby/messages/MessageFilter$a;->aGu:Ljava/util/Set;
    ...
    iget-object v5, v0, Lcom/google/android/gms/nearby/messages/MessageFilter$a;->aGq:Ljava/util/List;

    iget-boolean v6, v0, Lcom/google/android/gms/nearby/messages/MessageFilter$a;->aGr:Z

    new-instance v7, Ljava/util/ArrayList;

    iget-object v2, v0, Lcom/google/android/gms/nearby/messages/MessageFilter$a;->aGv:Ljava/util/Set;

    invoke-direct {v7, v2}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iget v8, v0, Lcom/google/android/gms/nearby/messages/MessageFilter$a;->aGt:I
    ...
    sput-object v1, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGo:Lcom/google/android/gms/nearby/messages/MessageFilter;
...
.method constructor <init>(ILjava/util/List;Ljava/util/List;ZLjava/util/List;I)V
    ...
    iput p1, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->awP:I
    ...
    iput-object p1, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGp:Ljava/util/List;

    iput-boolean p4, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGr:Z
    ...
    iput-object p1, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGq:Ljava/util/List;
    ...
    iput p6, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGt:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v1, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGr:Z

    iget-boolean v3, p1, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGr:Z

    if-ne v1, v3, :cond_2

    iget-object v1, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGp:Ljava/util/List;

    iget-object v3, p1, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGp:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGq:Ljava/util/List;

    iget-object v3, p1, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGq:Ljava/util/List;
    ...
    iget-object p1, p1, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGs:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGr:Z
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGp:Ljava/util/List;

    const/4 v1, 0x1

    invoke-static {p1, v1, v0}, Lcom/google/android/gms/common/internal/safeparcel/b;->a(Landroid/os/Parcel;ILjava/util/List;)V

    iget-object v0, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGq:Ljava/util/List;
    ...
    iget v0, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->aGt:I

    const/4 v1, 0x5

    invoke-static {p1, v1, v0}, Lcom/google/android/gms/common/internal/safeparcel/b;->d(Landroid/os/Parcel;II)V

    iget v0, p0, Lcom/google/android/gms/nearby/messages/MessageFilter;->awP:I
