...
.field final zzk:Ljava/util/concurrent/ExecutorService;
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
.end field

.field private zzl:Landroid/os/Binder;
...
.method public constructor <init>()V
    ...
    .line 5
    invoke-interface {v0, v1}, Lcom/google/android/gms/internal/e/a;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/iid/zzb;->zzk:Ljava/util/concurrent/ExecutorService;
    ...
    .line 7
    iput v0, p0, Lcom/google/firebase/iid/zzb;->zzn:I
...
.method private final zza(Landroid/content/Intent;)V
    ...
    .line 31
    iget v0, p0, Lcom/google/firebase/iid/zzb;->zzm:I
...
.method public final declared-synchronized onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    .line 10
    :cond_0
    iget-object p1, p0, Lcom/google/firebase/iid/zzb;->zzl:Landroid/os/Binder;

    if-nez p1, :cond_1

    .line 11
    new-instance p1, Lcom/google/firebase/iid/ag;

    invoke-direct {p1, p0}, Lcom/google/firebase/iid/ag;-><init>(Lcom/google/firebase/iid/zzb;)V

    iput-object p1, p0, Lcom/google/firebase/iid/zzb;->zzl:Landroid/os/Binder;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 14
    :try_start_0
    iput p3, p0, Lcom/google/firebase/iid/zzb;->zzm:I

    .line 15
    iget p3, p0, Lcom/google/firebase/iid/zzb;->zzn:I
    ...
    .line 24
    :cond_1
    iget-object p3, p0, Lcom/google/firebase/iid/zzb;->zzk:Ljava/util/concurrent/ExecutorService;

    new-instance v0, Lcom/google/firebase/iid/ad;

    invoke-direct {v0, p0, p2, p1}, Lcom/google/firebase/iid/ad;-><init>(Lcom/google/firebase/iid/zzb;Landroid/content/Intent;Landroid/content/Intent;)V
