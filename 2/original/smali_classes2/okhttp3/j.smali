...
.field private final bmb:J

.field final bmc:Ljava/lang/Runnable;

.field final bmd:Ljava/util/Deque;
...
.method private constructor <init>(Ljava/util/concurrent/TimeUnit;)V
    ...
    iput-object v0, p0, Lokhttp3/j;->bmc:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lokhttp3/j;->bmd:Ljava/util/Deque;
    ...
    iput-object v0, p0, Lokhttp3/j;->bme:Lokhttp3/internal/b/d;

    const/4 v0, 0x5

    .line 90
    iput v0, p0, Lokhttp3/j;->bma:I
    ...
    iput-wide v0, p0, Lokhttp3/j;->bmb:J
...
.method final aj(J)J
    ...
    .line 207
    :try_start_0
    iget-object v0, p0, Lokhttp3/j;->bmd:Ljava/util/Deque;
    ...
    .line 1257
    iget-object v8, v7, Lokhttp3/internal/b/c;->bpV:Ljava/util/List;
    ...
    .line 1534
    iget-object v12, v7, Lokhttp3/internal/b/c;->bpN:Lokhttp3/y;

    .line 2058
    iget-object v12, v12, Lokhttp3/y;->boF:Lokhttp3/a;

    .line 2093
    iget-object v12, v12, Lokhttp3/a;->bje:Lokhttp3/s;
    ...
    iget-object v10, v10, Lokhttp3/internal/b/g$a;->bqi:Ljava/lang/Object;
    ...
    .line 1274
    iput-boolean v10, v7, Lokhttp3/internal/b/c;->bpS:Z
    ...
    .line 1278
    iget-wide v8, p0, Lokhttp3/j;->bmb:J

    sub-long v8, p1, v8

    iput-wide v8, v7, Lokhttp3/internal/b/c;->bpW:J
    ...
    .line 219
    iget-wide v8, v7, Lokhttp3/internal/b/c;->bpW:J
    ...
    .line 226
    :cond_5
    iget-wide p1, p0, Lokhttp3/j;->bmb:J

    cmp-long v0, v3, p1

    if-gez v0, :cond_9

    iget p1, p0, Lokhttp3/j;->bma:I
    ...
    .line 239
    :cond_8
    iput-boolean v1, p0, Lokhttp3/j;->bmf:Z
    ...
    :cond_9
    :goto_3
    iget-object p1, p0, Lokhttp3/j;->bmd:Ljava/util/Deque;
    ...
    .line 2543
    iget-object p1, v5, Lokhttp3/internal/b/c;->bpP:Ljava/net/Socket;
