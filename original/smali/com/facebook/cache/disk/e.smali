...
.field private final CG:Lcom/facebook/common/d/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field volatile Di:Lcom/facebook/cache/disk/e$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/facebook/cache/disk/e;->Cq:Ljava/lang/Class;
...
.method public constructor <init>(ILcom/facebook/common/d/k;Ljava/lang/String;Lcom/facebook/cache/common/a;)V
    ...
    .line 56
    iput-object p4, p0, Lcom/facebook/cache/disk/e;->Cv:Lcom/facebook/cache/common/a;

    .line 57
    iput-object p2, p0, Lcom/facebook/cache/disk/e;->CG:Lcom/facebook/common/d/k;

    .line 58
    iput-object p3, p0, Lcom/facebook/cache/disk/e;->CF:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/facebook/cache/disk/e;->Di:Lcom/facebook/cache/disk/e$a;

    return-void
.end method

.method private declared-synchronized eY()Lcom/facebook/cache/disk/c;
    .locals 4
    ...
    .line 1162
    :try_start_0
    iget-object v0, p0, Lcom/facebook/cache/disk/e;->Di:Lcom/facebook/cache/disk/e$a;

    .line 1163
    iget-object v1, v0, Lcom/facebook/cache/disk/e$a;->Dj:Lcom/facebook/cache/disk/c;

    if-eqz v1, :cond_1

    iget-object v1, v0, Lcom/facebook/cache/disk/e$a;->Dk:Ljava/io/File;

    if-eqz v1, :cond_1

    iget-object v0, v0, Lcom/facebook/cache/disk/e$a;->Dk:Ljava/io/File;
    ...
    iget-object v0, v0, Lcom/facebook/cache/disk/e$a;->Dj:Lcom/facebook/cache/disk/c;
    ...
    iget-object v1, p0, Lcom/facebook/cache/disk/e;->CG:Lcom/facebook/common/d/k;
    ...
    iget-object v2, p0, Lcom/facebook/cache/disk/e;->CF:Ljava/lang/String;
    ...
    .line 1196
    :try_start_2
    sget-object v1, Lcom/facebook/cache/disk/e;->Cq:Ljava/lang/Class;
    ...
    iget-object v3, p0, Lcom/facebook/cache/disk/e;->Cv:Lcom/facebook/cache/common/a;
    ...
    iput-object v2, p0, Lcom/facebook/cache/disk/e;->Di:Lcom/facebook/cache/disk/e$a;
...
.method public final a(Lcom/facebook/cache/disk/c$a;)J
    ...
    .line 127
    invoke-direct {p0}, Lcom/facebook/cache/disk/e;->eY()Lcom/facebook/cache/disk/c;
...
.method public final eP()Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0}, Lcom/facebook/cache/disk/c;->eP()Ljava/util/Collection;
