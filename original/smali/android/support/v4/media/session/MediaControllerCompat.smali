...
# instance fields
.field private final ah:Landroid/support/v4/media/session/MediaControllerCompat$b;

.field private final ai:Ljava/util/HashSet;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->ai:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->ah:Landroid/support/v4/media/session/MediaControllerCompat$b;
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaControllerCompat;->ah:Landroid/support/v4/media/session/MediaControllerCompat$b;
...
.method public final dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 310
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->ah:Landroid/support/v4/media/session/MediaControllerCompat$b;

    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$b;->dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
