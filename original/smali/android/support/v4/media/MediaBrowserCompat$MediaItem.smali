...
# instance fields
.field private final L:Landroid/support/v4/media/MediaDescriptionCompat;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaItem;->L:Landroid/support/v4/media/MediaDescriptionCompat;
...
.method private constructor <init>(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    .line 2220
    iget-object v0, p1, Landroid/support/v4/media/MediaDescriptionCompat;->T:Ljava/lang/String;
...
.method public static a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Landroid/media/browse/MediaBrowser$MediaItem;->getFlags()I

    move-result v4

    .line 2149
    invoke-virtual {v3}, Landroid/media/browse/MediaBrowser$MediaItem;->getDescription()Landroid/media/MediaDescription;
    ...
    invoke-direct {v5, v3, v4}, Landroid/support/v4/media/MediaBrowserCompat$MediaItem;-><init>(Landroid/support/v4/media/MediaDescriptionCompat;I)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaItem;->L:Landroid/support/v4/media/MediaDescriptionCompat;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 551
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaItem;->L:Landroid/support/v4/media/MediaDescriptionCompat;
