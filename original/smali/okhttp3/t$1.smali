...
.method public final a(Lokhttp3/j;Lokhttp3/a;Lokhttp3/internal/b/g;)Ljava/net/Socket;
    ...
    :cond_1
    :goto_0
    iget-object p1, p1, Lokhttp3/j;->bmd:Ljava/util/Deque;
    ...
    .line 3141
    invoke-virtual {v0}, Lokhttp3/internal/b/c;->AR()Z
    ...
    .line 3142
    invoke-virtual {p3}, Lokhttp3/internal/b/g;->AW()Lokhttp3/internal/b/c;
    ...
    iget-object p1, p3, Lokhttp3/internal/b/g;->bnI:Lokhttp3/j;
    ...
    :cond_4
    :goto_1
    iget-object p1, p3, Lokhttp3/internal/b/g;->bqo:Lokhttp3/internal/c/c;

    if-nez p1, :cond_5

    iget-object p1, p3, Lokhttp3/internal/b/g;->bql:Lokhttp3/internal/b/c;
    ...
    .line 3512
    iput-object v0, p3, Lokhttp3/internal/b/g;->bql:Lokhttp3/internal/b/c;

    .line 3513
    iget-object p3, v0, Lokhttp3/internal/b/c;->bpV:Ljava/util/List;
...
.method public final a(Lokhttp3/j;)Lokhttp3/internal/b/d;
    ...
    .line 171
    iget-object p1, p1, Lokhttp3/j;->bme:Lokhttp3/internal/b/d;
...
.method public final a(Lokhttp3/e;)Lokhttp3/internal/b/g;
    ...
    .line 6151
    iget-object p1, p1, Lokhttp3/v;->bnZ:Lokhttp3/internal/c/j;

    .line 7102
    iget-object p1, p1, Lokhttp3/internal/c/j;->bqv:Lokhttp3/internal/b/g;
...
.method public final a(Lokhttp3/k;Ljavax/net/ssl/SSLSocket;Z)V
    ...
    iget-object v2, p1, Lokhttp3/k;->bmp:[Ljava/lang/String;
    ...
    .line 5170
    :goto_0
    iget-object v1, p1, Lokhttp3/k;->bmq:[Ljava/lang/String;

    if-eqz v1, :cond_1

    .line 5171
    sget-object v1, Lokhttp3/internal/c;->aRk:Ljava/util/Comparator;
    ...
    .line 5177
    sget-object v3, Lokhttp3/h;->bjJ:Ljava/util/Comparator;
    ...
    .line 5187
    invoke-virtual {p1}, Lokhttp3/k$a;->zZ()Lokhttp3/k;

    move-result-object p1

    .line 5154
    iget-object p3, p1, Lokhttp3/k;->bmq:[Ljava/lang/String;
    ...
    .line 5157
    :cond_3
    iget-object p3, p1, Lokhttp3/k;->bmp:[Ljava/lang/String;

    if-eqz p3, :cond_4

    .line 5158
    iget-object p1, p1, Lokhttp3/k;->bmp:[Ljava/lang/String;
...
.method public final a(Lokhttp3/j;Lokhttp3/internal/b/c;)Z
    ...
    :cond_1
    :goto_0
    iget-boolean v0, p2, Lokhttp3/internal/b/c;->bpS:Z

    if-nez v0, :cond_3

    iget v0, p1, Lokhttp3/j;->bma:I
...
.method public final b(Lokhttp3/j;Lokhttp3/internal/b/c;)V
    ...
    :cond_1
    :goto_0
    iget-boolean v0, p1, Lokhttp3/j;->bmf:Z
    ...
    .line 4152
    iput-boolean v0, p1, Lokhttp3/j;->bmf:Z

    .line 4153
    sget-object v0, Lokhttp3/j;->executor:Ljava/util/concurrent/Executor;

    iget-object v1, p1, Lokhttp3/j;->bmc:Ljava/lang/Runnable;
