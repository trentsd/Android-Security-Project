...
# static fields
.field public static final bnl:Lokhttp3/MediaType;

.field public static final bnm:Lokhttp3/MediaType;
...
.field private static final bnq:[B

.field private static final bnr:[B

.field private static final bns:[B


# instance fields
.field private final bnt:Lokio/ByteString;

.field private final bnu:Lokhttp3/MediaType;

.field private final bnv:Lokhttp3/MediaType;

.field private final bnw:Ljava/util/List;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/MultipartBody;->bnl:Lokhttp3/MediaType;
    ...
    sput-object v0, Lokhttp3/MultipartBody;->bnm:Lokhttp3/MediaType;
    ...
    sput-object v1, Lokhttp3/MultipartBody;->bnq:[B
    ...
    sput-object v1, Lokhttp3/MultipartBody;->bnr:[B
    ...
    sput-object v0, Lokhttp3/MultipartBody;->bns:[B
...
.method public constructor <init>(Lokio/ByteString;Lokhttp3/MediaType;Ljava/util/List;)V
    ...
    .line 75
    iput-object p1, p0, Lokhttp3/MultipartBody;->bnt:Lokio/ByteString;

    .line 76
    iput-object p2, p0, Lokhttp3/MultipartBody;->bnu:Lokhttp3/MediaType;
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->bnv:Lokhttp3/MediaType;
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->bnw:Ljava/util/List;
...
.method private a(Lokio/BufferedSink;Z)J
    ...
    .line 132
    :goto_0
    iget-object v1, p0, Lokhttp3/MultipartBody;->bnw:Ljava/util/List;
    ...
    .line 133
    iget-object v6, p0, Lokhttp3/MultipartBody;->bnw:Ljava/util/List;
    ...
    .line 134
    iget-object v7, v6, Lokhttp3/MultipartBody$Part;->bny:Lokhttp3/Headers;

    .line 135
    iget-object v6, v6, Lokhttp3/MultipartBody$Part;->bnz:Lokhttp3/RequestBody;

    .line 137
    sget-object v8, Lokhttp3/MultipartBody;->bns:[B

    invoke-interface {p1, v8}, Lokio/BufferedSink;->A([B)Lokio/BufferedSink;

    .line 138
    iget-object v8, p0, Lokhttp3/MultipartBody;->bnt:Lokio/ByteString;

    invoke-interface {p1, v8}, Lokio/BufferedSink;->i(Lokio/ByteString;)Lokio/BufferedSink;

    .line 139
    sget-object v8, Lokhttp3/MultipartBody;->bnr:[B
    ...
    .line 1077
    iget-object v8, v7, Lokhttp3/Headers;->bmU:[Ljava/lang/String;
    ...
    sget-object v11, Lokhttp3/MultipartBody;->bnq:[B
    ...
    sget-object v11, Lokhttp3/MultipartBody;->bnr:[B
    ...
    sget-object v10, Lokhttp3/MultipartBody;->bnr:[B
    ...
    :cond_4
    :goto_3
    sget-object v9, Lokhttp3/MultipartBody;->bnr:[B
    ...
    .line 176
    :goto_4
    sget-object v6, Lokhttp3/MultipartBody;->bnr:[B
    ...
    .line 179
    :cond_6
    sget-object v1, Lokhttp3/MultipartBody;->bns:[B

    invoke-interface {p1, v1}, Lokio/BufferedSink;->A([B)Lokio/BufferedSink;

    .line 180
    iget-object v1, p0, Lokhttp3/MultipartBody;->bnt:Lokio/ByteString;
    ...
    .line 182
    sget-object v1, Lokhttp3/MultipartBody;->bnr:[B
...
.method public final contentType()Lokhttp3/MediaType;
    ...
    .line 104
    iget-object v0, p0, Lokhttp3/MultipartBody;->bnv:Lokhttp3/MediaType;
