...
.field private static final brA:Ljava/util/concurrent/ExecutorService;


# instance fields
.field final bpP:Ljava/net/Socket;

.field final brB:Z

.field final brC:Lokhttp3/internal/e/g$b;
...
.field private final brG:Ljava/util/concurrent/ScheduledExecutorService;

.field private final brH:Ljava/util/concurrent/ExecutorService;

.field final brI:Lokhttp3/internal/e/l;
...
.field brM:Lokhttp3/internal/e/m;

.field final brN:Lokhttp3/internal/e/m;

.field brO:Z

.field final brP:Lokhttp3/internal/e/j;

.field final brQ:Lokhttp3/internal/e/g$d;

.field final brR:Ljava/util/Set;
...
.method static constructor <clinit>()V
    ...
    sput-object v8, Lokhttp3/internal/e/g;->brA:Ljava/util/concurrent/ExecutorService;
...
.method constructor <init>(Lokhttp3/internal/e/g$a;)V
    ...
    .line 116
    iput-wide v2, v0, Lokhttp3/internal/e/g;->brK:J
    ...
    iput-object v2, v0, Lokhttp3/internal/e/g;->brM:Lokhttp3/internal/e/m;
    ...
    iput-object v2, v0, Lokhttp3/internal/e/g;->brN:Lokhttp3/internal/e/m;

    const/4 v2, 0x0

    .line 131
    iput-boolean v2, v0, Lokhttp3/internal/e/g;->brO:Z
    ...
    iput-object v3, v0, Lokhttp3/internal/e/g;->brR:Ljava/util/Set;

    .line 139
    iget-object v3, v1, Lokhttp3/internal/e/g$a;->brI:Lokhttp3/internal/e/l;

    iput-object v3, v0, Lokhttp3/internal/e/g;->brI:Lokhttp3/internal/e/l;

    .line 140
    iget-boolean v3, v1, Lokhttp3/internal/e/g$a;->brB:Z

    iput-boolean v3, v0, Lokhttp3/internal/e/g;->brB:Z

    .line 141
    iget-object v3, v1, Lokhttp3/internal/e/g$a;->brC:Lokhttp3/internal/e/g$b;

    iput-object v3, v0, Lokhttp3/internal/e/g;->brC:Lokhttp3/internal/e/g$b;
    ...
    :goto_0
    iput v3, v0, Lokhttp3/internal/e/g;->brE:I
    ...
    .line 145
    iget v3, v0, Lokhttp3/internal/e/g;->brE:I
    ...
    .line 153
    iget-object v3, v0, Lokhttp3/internal/e/g;->brM:Lokhttp3/internal/e/m;
    ...
    iput-object v3, v0, Lokhttp3/internal/e/g;->brG:Ljava/util/concurrent/ScheduledExecutorService;

    .line 160
    iget v3, v1, Lokhttp3/internal/e/g$a;->brZ:I

    if-eqz v3, :cond_3

    .line 161
    iget-object v6, v0, Lokhttp3/internal/e/g;->brG:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iput-object v3, v0, Lokhttp3/internal/e/g;->brH:Ljava/util/concurrent/ExecutorService;

    .line 169
    iget-object v2, v0, Lokhttp3/internal/e/g;->brN:Lokhttp3/internal/e/m;
    ...
    invoke-virtual {v2}, Lokhttp3/internal/e/m;->BB()I

    move-result v2

    int-to-long v2, v2

    iput-wide v2, v0, Lokhttp3/internal/e/g;->brL:J

    .line 172
    iget-object v2, v1, Lokhttp3/internal/e/g$a;->bpP:Ljava/net/Socket;

    iput-object v2, v0, Lokhttp3/internal/e/g;->bpP:Ljava/net/Socket;

    .line 173
    new-instance v2, Lokhttp3/internal/e/j;

    iget-object v3, v1, Lokhttp3/internal/e/g$a;->bpR:Lokio/BufferedSink;

    iget-boolean v4, v0, Lokhttp3/internal/e/g;->brB:Z

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/e/j;-><init>(Lokio/BufferedSink;Z)V

    iput-object v2, v0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;
    ...
    iget-object v1, v1, Lokhttp3/internal/e/g$a;->boD:Lokio/d;
    ...
    iput-object v2, v0, Lokhttp3/internal/e/g;->brQ:Lokhttp3/internal/e/g$d;

    return-void
.end method

.method static synthetic Bm()Ljava/util/concurrent/ExecutorService;
    .locals 1

    .line 61
    sget-object v0, Lokhttp3/internal/e/g;->brA:Ljava/util/concurrent/ExecutorService;
...
.method private a(Lokhttp3/internal/e/b;)V
    ...
    .line 422
    iget-object v0, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;
    ...
    .line 425
    :try_start_1
    iget-boolean v1, p0, Lokhttp3/internal/e/g;->brF:Z
    ...
    .line 428
    :try_start_3
    iput-boolean v1, p0, Lokhttp3/internal/e/g;->brF:Z

    .line 429
    iget v1, p0, Lokhttp3/internal/e/g;->brD:I
    ...
    .line 433
    :try_start_4
    iget-object v2, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;

    sget-object v3, Lokhttp3/internal/c;->boO:[B
...
.method static synthetic b(Lokhttp3/internal/e/g;)V
    ...
    .line 61
    invoke-virtual {p0}, Lokhttp3/internal/e/g;->Bk()V
...
.method static synthetic c(Lokhttp3/internal/e/g;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 61
    iget-object p0, p0, Lokhttp3/internal/e/g;->brG:Ljava/util/concurrent/ScheduledExecutorService;
...
.method static synthetic d(Lokhttp3/internal/e/g;)Z
    ...
    .line 61
    iput-boolean v0, p0, Lokhttp3/internal/e/g;->brJ:Z
...
# virtual methods
.method public final declared-synchronized Bj()I
    .locals 2
    ...
    .line 201
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/e/g;->brN:Lokhttp3/internal/e/m;

    .line 1099
    iget v1, v0, Lokhttp3/internal/e/m;->bsL:I

    and-int/lit8 v1, v1, 0x10

    if-eqz v1, :cond_0

    iget-object v0, v0, Lokhttp3/internal/e/m;->bsM:[I
...
.method public final Bl()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/e/j;->Bx()V

    .line 515
    iget-object v0, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;

    iget-object v1, p0, Lokhttp3/internal/e/g;->brM:Lokhttp3/internal/e/m;

    invoke-virtual {v0, v1}, Lokhttp3/internal/e/j;->c(Lokhttp3/internal/e/m;)V

    .line 516
    iget-object v0, p0, Lokhttp3/internal/e/g;->brM:Lokhttp3/internal/e/m;

    invoke-virtual {v0}, Lokhttp3/internal/e/m;->BB()I
    ...
    iget-object v1, p0, Lokhttp3/internal/e/g;->brQ:Lokhttp3/internal/e/g$d;
...
.method final a(ILokhttp3/internal/e/b;)V
    ...
    .line 327
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/e/g;->brG:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final a(IZLokio/c;J)V
    ...
    .line 294
    iget-object p4, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;
    ...
    :goto_1
    :try_start_0
    iget-wide v3, p0, Lokhttp3/internal/e/g;->brL:J
    ...
    .line 316
    iget-object v3, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;

    .line 1157
    iget v3, v3, Lokhttp3/internal/e/j;->bsB:I
    ...
    .line 317
    iget-wide v4, p0, Lokhttp3/internal/e/g;->brL:J

    int-to-long v6, v3

    sub-long/2addr v4, v6

    iput-wide v4, p0, Lokhttp3/internal/e/g;->brL:J
    ...
    .line 321
    iget-object v4, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;
...
.method final declared-synchronized a(Lokhttp3/internal/b;)V
    ...
    .line 922
    iget-object v0, p0, Lokhttp3/internal/e/g;->brH:Ljava/util/concurrent/ExecutorService;
...
.method final a(Lokhttp3/internal/e/b;Lokhttp3/internal/e/b;)V
    ...
    :cond_2
    :try_start_3
    iget-object p2, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;
    ...
    :goto_3
    :try_start_4
    iget-object p2, p0, Lokhttp3/internal/e/g;->bpP:Ljava/net/Socket;
    ...
    .line 487
    :goto_4
    iget-object p2, p0, Lokhttp3/internal/e/g;->brG:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-interface {p2}, Ljava/util/concurrent/ScheduledExecutorService;->shutdown()V

    .line 488
    iget-object p2, p0, Lokhttp3/internal/e/g;->brH:Ljava/util/concurrent/ExecutorService;
...
.method final declared-synchronized al(J)V
    ...
    .line 205
    :try_start_0
    iget-wide v0, p0, Lokhttp3/internal/e/g;->brK:J

    add-long/2addr v0, p1

    iput-wide v0, p0, Lokhttp3/internal/e/g;->brK:J

    .line 206
    iget-wide p1, p0, Lokhttp3/internal/e/g;->brK:J
    ...
    .line 208
    iput-wide p1, p0, Lokhttp3/internal/e/g;->brK:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final c(Ljava/util/List;Z)Lokhttp3/internal/e/i;
    ...
    .line 242
    iget-object v7, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;
    ...
    .line 244
    :try_start_1
    iget v0, p0, Lokhttp3/internal/e/g;->brE:I
    ...
    .line 247
    :cond_0
    iget-boolean v0, p0, Lokhttp3/internal/e/g;->brF:Z

    if-nez v0, :cond_5

    .line 250
    iget v8, p0, Lokhttp3/internal/e/g;->brE:I
    ...
    iput v0, p0, Lokhttp3/internal/e/g;->brE:I
    ...
    .line 253
    iget-wide v0, p0, Lokhttp3/internal/e/g;->brL:J
    ...
    iget-wide v0, v9, Lokhttp3/internal/e/i;->brL:J
    ...
    .line 268
    iget-object p1, p0, Lokhttp3/internal/e/g;->brP:Lokhttp3/internal/e/j;
